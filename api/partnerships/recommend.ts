...
const ADVISOR_SYSTEM = `You are a solution-fit advisor for Wright Adventures, a nonprofit technology consulting firm based in Colorado.
...
function buildAdvisorPrompt(
  opp: { name: string; description?: string | null; status?: string | null; partner_org?: string | null; partnership_type?: string | null; estimated_value?: number | null },
  pd:  { org_size?: string | null; pain_points?: string | null; tech_stack_notes?: string | null; qualification_notes?: string | null },
): string {
  const lines: string[] = [
