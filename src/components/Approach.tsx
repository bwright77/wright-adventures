...
function ApproachStep({ step, index }: { step: typeof APPROACH_STEPS[number]; index: number }) {
  ...
  return (
    <div
      ref={ref}
      style={style}
      className="p-7 rounded-xl bg-white/[0.04] border border-white/[0.08]"
    >
      <div className="text-5xl font-bold text-white/[0.08] leading-none mb-4">
        {step.number}
      </div>
...
export function Approach() {
  return (
    <section id="approach" className="py-24 px-6 lg:px-12 bg-navy relative overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-river/[0.06] to-transparent pointer-events-none" />

      <div className="max-w-7xl mx-auto relative z-10">
        <span className="section-label !text-white/40">Our Approach</span>
